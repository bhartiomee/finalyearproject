...
const Header = ({ auth: { isAuthenticated, loading, user }, logout }) => {
  ...
  const authTabs = (
    <div className='s-navigation'>
      ...
      <Link to='/cat_question' className='s-navigation--item'>
        Questions
      </Link>
      <Link to='/cat_blog' className='s-navigation--item'>
        Blogs
      </Link>
    </div>
  );
  ...
  const guestTabs = (
    <div className='s-navigation'>
      ...
      <Link to='/cat_question' className='s-navigation--item not-selected'>
        Questions
      </Link>
      <Link to='/cat_blog' className='s-navigation--item not-selected'>
        Blogs
      </Link>
    </div>
  );
